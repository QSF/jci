...
<input type="text" id="idStateRegistration" name="stateRegistration" value="<?php echo $user->getStateRegistration()?>"/></td>


<label for="ownerPhone">Telefone do responsável</label>
<input type="text" id="idOwnerPhone" name="ownerPhone"  value="<?php echo $user->getOwnerPhone()?>" maxlength=12/></td>
